...
We use the moment-based method of Tavare [CITE] in order to compute the expected number of lineages as a function of time (with no mutation) under the Kingman coalescent:
