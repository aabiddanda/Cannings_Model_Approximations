...
%We would also like to obtain the expected Site Frequency Spectrum (SFS) under the Moran Model. We will assume for the time-being that we have a constant size population 
