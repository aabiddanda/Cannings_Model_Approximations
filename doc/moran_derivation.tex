...
\begin{center}
	\begin{figure}[!ht]
		\includegraphics[scale=0.85]{../plots/moran_figure3}
		\caption{Percent difference in NLFT between the Moran model and the Coalescent. The generations ($t$) are measured as Moran Generation. The population size is constant $N=20000$ and the sample sizes are shown in the legend.}
	\end{figure}
\end{center}
