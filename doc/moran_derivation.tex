...
% \subsection{Cannings Exchangeable Models}

% The Moran and DTWF models fall under the broader category of the Cannings Exchangeable Models. It has been shown by Kingman [CITE] that the ancestral process of these models all converge to the Kingman coalescent in the ``diffusion limit'', as $N \rightarrow \infty$. This occurs in the diffusion limit because we are able to rescale time by $N_e$ ($N_e = N$ in the DTWF, $N_e = \frac{N^2}{2}$ in the Moran model).   
