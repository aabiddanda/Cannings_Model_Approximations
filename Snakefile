...
rule moran_figure2:
	input:
		coal_nlft = expand('data/nlft/nlft_coal_n{n}_N{N}_{time}.txt', N=20000, n=[20,200,2000], time=1000000),
		moran_nlft = expand('data/nlft/nlft_moran_n{n}_N{N}_{time}.txt', N=20000, n=[20,200,2000], time=1000000)
	output:
...
rule moran_figure2a:
	input:
		coal_nlft = expand('data/nlft/nlft_coal_n{n}_N{N}_{time}.txt', N=2000, n=[20,200,2000], time=1000000),
		moran_nlft = expand('data/nlft/nlft_moran_n{n}_N{N}_{time}.txt', N=2000, n=[20,200,2000], time=1000000)
	output:
...
rule moran_figure4:
	input:
		dtwf_nlft = expand('data/nlft/nlft_dtwf_n{n}_N{N}_{time}.txt', n=[2000], N=20000, time=1000000),
		moran_nlft = expand('data/nlft/nlft_moran_n{n}_N{N}_{time}.txt', n=[2000], N=20000, time=1000000),
		coal_nlft = expand('data/nlft/nlft_coal_n{n}_N{N}_{time}.txt', n=[2000], N=20000, time=1000000)
	output:
